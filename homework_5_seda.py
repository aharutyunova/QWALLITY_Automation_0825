...
# TODO - Good, you could also revert the set back to the list
...
# TODO: It would be more correct to keep the tuple structured as key–value pairs, 
# so it can be directly converted into a dictionary using dict().

students = (("name", "Anna"), ("surname", "Simonyan"), ("phone", "37498521462"), ("gender", "female"))
print(dict(students))
