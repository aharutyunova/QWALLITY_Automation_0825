...
# TODO: When you remove index 0, the remaining indexes shift 
# (so the original index 4 becomes index 3, etc.). 
# To avoid this, remove elements starting from the last index: 
# pop(5), pop(4), and then pop(0). 
# This way, the original indexes won’t change.
